...
- [X] T025 [P] [US1] Add Playwright mobile coverage for supported add, custom-product creation, duplicate focus, and invalid-input feedback in src/test/java/dev/casteels/plukk/e2e/AddShoppingNeedE2ETest.java
